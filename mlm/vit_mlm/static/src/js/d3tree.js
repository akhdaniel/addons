openerp.vit_mlm = function(instance) {
    var _t = instance.web._t;
    
    instance.web.form.FieldD3tree = instance.web.form.AbstractField.extend(instance.web.form.ReinitializeWidgetMixin, {
        template: 'FieldD3tree',
        content: "",
        init: function() {
            console.log("d3 widget init");
            var self = this;
        ...
        initialize_content: function() {
            var self = this;
            console.log("d3 widget initialize_content");
        ...
        render_value: function() {
            ...
            console.log("d3 widget render_value " + value);
            this.$el.html( '<iframe frameBorder="0" width="100%" height="700" style="width:100%;height:700px" src="' + this.get('value') + '"></iframe>');
            ...
            //             }).fail(function() {
            //                 self.$('.oe_pad_content').text(_t('Unable to load vit_mlm'));
            //             });
            //         } else {
            //             self.$('.oe_pad_content').addClass('oe_pad_loading').show().text(_t("This vit_mlm will be initialized on first edit"));
            //         }
            //     }
            //     else {
            //         var def = $.when();
    ...
    instance.web.form.widgets = instance.web.form.widgets.extend({
        'd3tree': 'instance.web.form.FieldD3tree',
    });
};
