...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        account_total_debit_per_move = 0.0
        account_total_credit_per_move = 0.0
        %>
        ...
        <div class="act_as_table list_table" style="margin-top: 5px;">
            ...
            %>
                ...
                <div class="act_as_tbody">
                    %if new_move and (account_total_debit_per_move != 0 or account_total_credit_per_move != 0):
                    <div class="act_as_row labels">
                        ## date
                    ...
                    account_total_debit_per_move += line.debit or 0.0
                    account_total_credit_per_move += line.credit or 0.0
                    %>                   
