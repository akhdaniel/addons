...
class account_invoice_report_garment(osv.osv):
    _name = "account.invoice.report.garment"
    ...
    _columns = {
        ...
        'origin': fields.char('Invoice Ref',readonly=True),
    ...
    def _select(self):
        select_str = """
            SELECT sub.id, sub.date, sub.invoice_id, sub.origin, sub.year, sub.month, sub.day, sub.product_id, sub.partner_id,
...
account_invoice_report_garment()
