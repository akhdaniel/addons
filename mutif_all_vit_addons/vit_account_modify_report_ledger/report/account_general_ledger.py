...
class general_ledger(report_sxw.rml_parse, common_report_header):
    _name = 'report.account.general.ledger2'
...
report_sxw.report_sxw('report.account.general.ledger2', 'account.account', 'addons/account/report/account_general_ledger.rml', parser=general_ledger, header='internal')
