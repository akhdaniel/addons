        ...
        if pick:
            ...
            for line in pick.move_lines:
                ...
                if qty > 0:
                    ...
                    result1.append({'product_id': line.product_id.id, 'quantity': 0.00, 'order': qty,'move_id':line.id, 'prodlot_id': line.prodlot_id and line.prodlot_id.id or False})
...
#        Create new picking for returned products
    ...
    def create_returns_orders(self, cr, uid, ids, context=None):
        """ 
         Creates return picking.
         @param self: The object pointer.
         @param cr: A database cursor
