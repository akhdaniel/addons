...
class move2(report_sxw.rml_parse): 
    def __init__(self, cr, uid, name, context): 
        super(move2, self).__init__(cr, uid, name, context) 
        self.localcontext.update({ 'time': time, }) 
        
report_sxw.report_sxw('report.move2', 'account.move', 'addons/vit_account_move_print/report/move2.rml', parser=move2,) 