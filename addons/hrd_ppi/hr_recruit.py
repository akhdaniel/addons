...
class hr_applicant(osv.osv):
    ...
    _columns= {
        ...
        'prov_id':fields.many2one('hr_recruit.prov','Provinsi', domain="[('countri_id','!=',country_id1)]"),
        ...
        'prov_id2':fields.many2one('hr_recruit.prov','Provinsi', domain="[('countri_id','!=',country_id2)]"),
