...
class hr_applicant(osv.osv):
    ...
    _columns= {
        ...
        'prov_id':fields.many2one('hr_recruit.prov','Provinsi', domain="[('countri_id.id','=',country_id1.id)]"),
        ...
        'prov_id2':fields.many2one('hr_recruit.prov','Provinsi', domain="[('countri_id.id','=',country_id2.id)]"),
