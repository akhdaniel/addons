...
class netpro_policy(osv.osv):
    ...
    _columns = {
        ...
        'province1_id': fields.many2one('res.country.state', 'Region 1'),
        'province2_id': fields.many2one('res.country.state', 'Region 2'),
        'province3_id': fields.many2one('res.country.state', 'Region 3'),
        'province4_id': fields.many2one('res.country.state', 'Region 4'),
        'province5_id': fields.many2one('res.country.state', 'Region 5'),
