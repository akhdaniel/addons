...
class vit_partner_aging_supplier(osv.Model):
    ...
    def init(self, cr):
        ...
        tools.drop_view_if_exists(cr, 'vit_partner_aging_supplier')
        cr.execute("""
            CREATE OR REPLACE VIEW vit_partner_aging_supplier AS (
