...
#            else:
    ...
    _columns = {
                ...
                'puerperium_monitor' : fields.one2many('medical.puerperium.monitor', 'name', 'Puerperium monitor'),
...
class Perinatal(orm.Model):
    ...
    _columns={
            ...
            'monitoring' : fields.one2many('medical.perinatal.monitor', 'name', string='Monitors'),
            'puerperium_monitor' : fields.one2many('medical.puerperium.monitor', 'name','Puerperium monitor'),
