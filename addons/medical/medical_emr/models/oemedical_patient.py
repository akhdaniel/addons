...
class OeMedicalPatient(orm.Model):
    ...
    _columns={
        ...
        'medications': fields.one2many('medical.patient.medication', 'patient_id', 
            string='Medications',),
        'evaluations': fields.one2many('medical.patient.evaluation', 'patient_id', 
            string='Evaluations',),
        ...
        'diseases': fields.one2many('medical.patient.disease', 'patient_id', 
            string='Diseases', help='Mark if the patient has died'),
        'ethnic_group': fields.many2one('medical.ethnicity', string='Ethnic group',),
        'vaccinations': fields.one2many('medical.patient.vaccination', 'patient_id', 'Vaccinations',),
