...
class wps(osv.osv):
    ...
    _columns = {
        ...
        'start_date': fields.datetime('Start Date', required=True, readonly=True, select=True),
        'end_date': fields.datetime('End Date', required=True, readonly=True, select=True),
