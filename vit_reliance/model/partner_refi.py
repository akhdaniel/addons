...
class partner(osv.osv):
	...
	_columns = {
		...
		#statement
		"refi_bulan_tahun_survey"				:	fields.char("REFI Bulan Tahun Survey"),
		"refi_time_deps_saving_account"			:	fields.float("REFI Time Deps Saving Account"),
		...
		"refi_mortagage_loan_inst"				:	fields.float("REFI Mortagage Loan Inst"),
		"refi_mortgage_loan_inst_balance"		:	fields.float("REFI Mortgage Loan Inst Balance"),
		...
		"refi_monthly_expenditure_balance"		:	fields.float("REFI Monthly Expenditure Balance"),
		"refi_mortgage_loan_int"				:	fields.float("REFI Mortgage Loan Int"),
		"refi_mortgage_loan_int_balance_equity"	:	fields.float("REFI Mortgage Loan Int Balance Equity"),
		"refi_other"							:	fields.float("REFI Other"),
		"refi_other_balance_equity_net_income"	:	fields.float("REFI Other Balance Equity Net Income"),
		"refi_spouse_income"					:	fields.float("REFI Spouse Income"),
		"refi_other_income"						:	fields.float("REFI Other Income	"),		

		"refi_kontrak_ids"						: 	fields.one2many('reliance.refi_kontrak','partner_id','Kontrak', ondelete="cascade"),
	}
