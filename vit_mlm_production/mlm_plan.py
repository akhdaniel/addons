...
class mlm_plan(osv.osv):
	...
	_columns 	= {
		...
		'max_bonus_produksi_level'	: fields.integer('Max Bonus Produksi Depth (Up)',
			help='Berapa jumlah level (keatas) dimana Upline masih dapat Bonus Produksi, isi dengan 0 jika yang mendapatkan bonus hanya sponsornya saja'),
		'bonus_produksi_percent_decrease': fields.float("Bonus Produksi Percent Decrease",
			help='Berapa persen penurunan Bonus Produksi untuk setiap level ke atasnya. Isi dengan 0.0-1.0, nilai 1 artinya tidak ada penurunan'),		
