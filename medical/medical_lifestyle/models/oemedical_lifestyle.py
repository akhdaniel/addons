...
# TODO:  If no more fields are needed, should be moved as one2many inside of medical_patient... 
    _name = 'medical.patient.recreational_drugs'
    _description = 'Patient use of Recreational Drugs'

    _columns = {
            'patient_id' : fields.many2one('medical.patient', 'Patient'),
            'recreational_drug' : fields.many2one('medical.drugs_recreational', 'Recreational Drug'),
        }
...
class MedicalPatient(orm.Model):
    ...
    'recreational_drugs' : fields.one2many( 'medical.patient.recreational_drugs', 'patient_id', 'Drugs'),
